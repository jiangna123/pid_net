...
parser.add_argument("--exp_name", type=str, default='mszs_train_256_1')
...
model.compile(optimizer=Adam(lr=optimizer_name),
              loss=loss_func,
              metrics=["accuracy", 'custom_precision', 'custom_recall', "cf1_score"])
...
val_ge = trainGenerator(2, data_root,
                        'val_image', 'val_label',
                        data_gen_args,
                        image_color_mode=color_mode.get(channels),
                        save_to_dir=None,
