...
parser.add_argument("--model_name", type=str, default="aspp-att-pid")
parser.add_argument("--exp_name", type=str, default="archive_train256_3")
parser.add_argument("--datatest_name", type=str, default="archive_test256_3")  # attunet-mszs
...
images = glob.glob(os.path.join(test_root, 'image', "*.jpg")) + glob.glob(
    os.path.join(test_root, 'image', "*.png")) + glob.glob(os.path.join(test_root, 'image', "*.jpeg"))
images.sort()
