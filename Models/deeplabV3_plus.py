...
from tensorflow.python.keras.layers import Activation, Conv2D, MaxPooling2D, BatchNormalization, Input, add, Dropout, \
    AveragePooling2D, Concatenate, Layer, InputSpec
...
def DeeplabV3_plus(nClasses=2, channels=1, input_height=256, input_width=256):
