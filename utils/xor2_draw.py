...
parser.add_argument("--channels", type=int, default=3)  # 默认单通道1
...
test_root = os.path.join("data", 'archive_test256_3_4')
# test_root = os.path.join("data", 'archive_test256_1')
...
output = 'data/output/xor/pid_net'
