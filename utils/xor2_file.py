...
tes = 'archive_test256_3_4'

parser = argparse.ArgumentParser()
parser.add_argument("--channels", type=int, default=3)  # 默认单通道1 3
...
def adjustData(image, mask, plabel, pedge, flag_multi_class, num_class):
    ...
    return image, mask, plabel, pedge,
